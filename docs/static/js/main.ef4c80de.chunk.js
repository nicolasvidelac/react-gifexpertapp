  ...
  [0],
  {
    ...
    17: function (e, t, n) {
      ...
      var a = n(9),
            ...
            onSubmit: function (e) {
              e.preventDefault(),
                o.trim().length > 3
                  ...
                  : console.error(
                      "La categoria debe tener al menos 3 cataracteres"
                    );
            },
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        (n =
                          "https://api.giphy.com/v1/gifs/search?api_key=HgIn1e8mcQ17yDMx3tOYIUwntGz8M45n&q=".concat(
                            encodeURI(t)
                          )),
                        (e.next = 3),
                        fetch(n)
                  ...
                  children: s.map(function (e) {
                    return Object(i.jsxs)(
                      "div",
                      {
                        className: "card",
                        children: [
                          Object(i.jsx)("img", { src: e.url, alt: e.title }),
                          Object(i.jsxs)("p", { children: [" ", e.title] }),
                        ],
                      },
                      e.id
                    );
        ...
        b = function () {
          var e = Object(r.useState)(["One Punch"]),
            t = Object(c.a)(e, 2),
            n = t[0],
            o = t[1];
          return Object(i.jsxs)(i.Fragment, {
            children: [
              Object(i.jsx)("h2", { children: "GifExpertApp" }),
              Object(i.jsx)("hr", {}),
              Object(i.jsx)(s, {
                setCategories: function (e) {
                  o([e].concat(Object(a.a)(n)));
                },
              ...
              Object(i.jsx)("hr", {}),
              n.map(function (e) {
                return Object(i.jsx)(d, { category: e }, e);
              }),
            ],
          });
        },
        p = n(8);
      n.n(p).a.render(Object(i.jsx)(b, {}), document.getElementById("root"));
    },
  },
  [[17, 1, 2]],
]);
